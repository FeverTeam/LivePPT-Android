...
package net.cloudslides.app.utils.imagetools;
...
import net.cloudslides.app.BuildConfig;
...
public class DiskLruCache {
	...
	public static File getDiskCacheDir(Context context, String uniqueName) {
		...
		final String cachePath = Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED) || !Utils.isExternalStorageRemovable() ? Utils
				...
				//File diskCacheDir = new File("/mnt/sdcard/"+uniqueName);
