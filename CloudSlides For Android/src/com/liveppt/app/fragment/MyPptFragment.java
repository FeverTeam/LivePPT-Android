...
import com.liveppt.app.activity.MainActivity;
import com.liveppt.app.model.PptFile;
import com.liveppt.app.utils.CustomProgressDialog;
	...
	private void getPptList()
	{
		...
		MyHttpClient.get(url, null, new AsyncHttpResponseHandler()
		{
		     ...
		     public void onFailure(Throwable e, String response) 
			{
				e.printStackTrace();
				MyToast.alert("网络异常!");
				Log.i("获取ppt列表onFailure", response);
		     }
		    @Override
