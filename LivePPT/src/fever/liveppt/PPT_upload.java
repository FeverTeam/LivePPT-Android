...
public class PPT_upload extends Activity implements OnClickListener {
	...
	private Button upload_butn,btnBack,btnFileChooser;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		upload_butn = (Button) this.findViewById(R.id.btn_upload);
		btnBack=(Button)this.findViewById(R.id.btn_upload_back);
		btnFileChooser=(Button)this.findViewById(R.id.btn_filechoser);
	...
	public void onActivityResult(int requestCode , int resultCode , Intent data){
		...
		if(resultCode == RESULT_OK && requestCode == REQUEST_CODE){
			...
			if(pptPath != null){
				btnFileChooser.setText(pptPath);				
			}
			else
