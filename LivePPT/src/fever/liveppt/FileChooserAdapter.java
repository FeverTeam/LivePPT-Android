...
public class FileChooserAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(fileInfo.isDirectory()){      //
			holder.imgFileIcon.setImageResource(R.drawable.img);
			holder.tvFileName.setTextColor(Color.GRAY);
		}
		else if(fileInfo.isPPTFile()){   //PPT
			holder.imgFileIcon.setImageResource(R.drawable.login);
			holder.tvFileName.setTextColor(Color.RED);
		}
		else {                           //
			holder.imgFileIcon.setImageResource(R.drawable.tip);
			holder.tvFileName.setTextColor(Color.GRAY);
		}
		return view;
	}
